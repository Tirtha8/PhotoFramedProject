...
<title>Admin Sign up | ProtoFramed</title>
</head>
<body>
	<div id="signupDashboard">Admin | PhotoFramed</div>
	...
	<div id="signupFormContainer">
		...
		<form:form action="createNewAdminAccount" method="post" modelAttribute="user">
			<table>
				<tr>
				...
				<tr>
					...
					<td><label>Already have an account? <a href="adminLogin"> Login </a></label></td>
				</tr>
			</table>
